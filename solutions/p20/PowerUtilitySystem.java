...
interface Billable { void generateEnergyBill(); }
...
abstract class Consumer {
    ...
    public Consumer(String consumerId, String consumerName, String address) {
        this.consumerId = consumerId; this.consumerName = consumerName; this.address = address;
    }
    public Consumer(String consumerId, String consumerName) { this(consumerId, consumerName, ""); }
...
abstract class EnergyConsumer extends Consumer {
    ...
    public EnergyConsumer(String consumerId, String consumerName, String address, String meterId,
                          double unitsConsumedKWh, double tariffRatePerUnit) {
        super(consumerId, consumerName, address);
        this.meterId = meterId; this.unitsConsumedKWh = unitsConsumedKWh; this.tariffRatePerUnit = tariffRatePerUnit;
        totalConsumers++;
    }
    public String getMeterId() { return meterId; }
    public double getUnitsConsumed() { return unitsConsumedKWh; }
    public double getTariffRate() { return tariffRatePerUnit; }
...
class IndustrialConsumer extends EnergyConsumer implements Billable {
    ...
    public IndustrialConsumer(String consumerId, String consumerName, String address, String meterId,
                              double unitsConsumedKWh, double tariffRatePerUnit,
                              double loadFactorPercent, double peakDemandKW, double demandChargePerKW) {
        super(consumerId, consumerName, address, meterId, unitsConsumedKWh, tariffRatePerUnit);
        this.loadFactorPercent = loadFactorPercent; this.peakDemandKW = peakDemandKW; this.demandChargePerKW = demandChargePerKW;
    }
    public double getLoadFactorPercent() { return loadFactorPercent; }
    public double getPeakDemandKW() { return peakDemandKW; }
    public double getDemandChargePerKW() { return demandChargePerKW; }

    public double calculateBill() {
        return getUnitsConsumed() * getTariffRate() + peakDemandKW * demandChargePerKW;
    }
    ...
    public void generateEnergyBill() {
        ...
        System.out.println("Energy Charge : " + getUnitsConsumed() + " kWh x " + getTariffRate() + " = " + (getUnitsConsumed() * getTariffRate()));
        System.out.println("Demand Charge : " + peakDemandKW + " kW x " + demandChargePerKW + " = " + (peakDemandKW * demandChargePerKW));
...
class HeavyIndustrialConsumer extends IndustrialConsumer {
    ...
    public HeavyIndustrialConsumer(String consumerId, String consumerName, String address, String meterId,
                                   double unitsConsumedKWh, double tariffRatePerUnit,
                                   double loadFactorPercent, double peakDemandKW, double demandChargePerKW,
                                   double powerFactorPenalty, double backupGeneratorKVA) {
        super(consumerId, consumerName, address, meterId, unitsConsumedKWh, tariffRatePerUnit,
                loadFactorPercent, peakDemandKW, demandChargePerKW);
        this.powerFactorPenalty = powerFactorPenalty; this.backupGeneratorKVA = backupGeneratorKVA;
    }

    public double calculateBill() {
        return super.calculateBill() + powerFactorPenalty + backupGeneratorKVA * 39.0;
    }
    public double calculateBill(double extraUnits) {
        return calculateBill() + extraUnits * getTariffRate();
    }
    ...
    public void generateEnergyBill() {
        ...
        double genCharge = backupGeneratorKVA * 39.0;
        System.out.println();
        ...
        System.out.println("Generator Charge : " + genCharge);
        System.out.println("TOTAL BILL       : " + calculateBill() + " BDT");
    }
...
class EnergyMeter {
    ...
    public EnergyMeter(String meterSerialNo, String meterType, String installationDate) {
        this.meterSerialNo = meterSerialNo; this.meterType = meterType; this.installationDate = installationDate;
    }
    public String getMeterSerialNo() { return meterSerialNo; }
...
public class PowerUtilitySystem {
    public static void main(String[] args) {
        EnergyMeter em = new EnergyMeter("MT-9981", "Smart Meter", "2022-08-10");

        IndustrialConsumer ic = new IndustrialConsumer("C001", "Apex Textiles", "Gazipur",
                em.getMeterSerialNo(), 12000.0, 8.5, 75.0, 500.0, 150.0);

        HeavyIndustrialConsumer hc = new HeavyIndustrialConsumer("C002", "Steel Works Ltd", "Chittagong",
                "MT-7742", 45000.0, 9.0, 80.0, 1200.0, 200.0, 25000.0, 500.0);
