...
class Bus extends Vehicle {
    ...
    public double calculateFare(double km, int pax) {
        double base = calculateFare(km);
        if (pax >= 30) return base * 0.95;
        return base;
    }
...
class LuxuryBus extends Bus {
    ...
    public LuxuryBus(String vehicleId, String routeName, double baseFare, int seatCapacity, double chargePerKm,
                     double comfortSurcharge, boolean hasLounge) {
...
public class TransportSystem {
    public static void main(String[] args) {
        ...
        LuxuryBus lb = new LuxuryBus("LB01", "Sylhet-Dhaka", 80.0, 30, 6.0, 200.0, true);
