...
interface Publishable { void publishResearch(); }
...
abstract class Person {
    ...
    public Person(String personId, String fullName, String dateOfBirth) {
        this.personId = personId; this.fullName = fullName; this.dateOfBirth = dateOfBirth;
    }
...
abstract class Staff extends Person {
    ...
    public Staff(String personId, String fullName, String dateOfBirth, String designation, double basicSalary, int joiningYear) {
        ...
        this.designation = designation; this.basicSalary = basicSalary; this.joiningYear = joiningYear;
        totalStaff++;
    }
...
class AcademicStaff extends Staff implements Publishable {
    ...
    public AcademicStaff(String personId, String fullName, String dateOfBirth, String designation, double basicSalary,
                         int joiningYear, int publicationsCount, double researchGrantAmount, String specialization) {
        super(personId, fullName, dateOfBirth, designation, basicSalary, joiningYear);
        this.publicationsCount = publicationsCount; this.researchGrantAmount = researchGrantAmount;
        this.specialization = specialization;
    }
    public int getPublicationsCount() { return publicationsCount; }
    public double getResearchGrantAmount() { return researchGrantAmount; }
...
class SeniorProfessor extends AcademicStaff {
    ...
    public SeniorProfessor(String personId, String fullName, String dateOfBirth, String designation, double basicSalary,
                           int joiningYear, int publicationsCount, double researchGrantAmount, String specialization,
                           int phdStudentsSupervised, double conferenceBonus) {
        ...
        this.phdStudentsSupervised = phdStudentsSupervised; this.conferenceBonus = conferenceBonus;
    }

    public double calculateCompensation() { return super.calculateCompensation() + conferenceBonus; }
    public double calculateCompensation(int months) { return calculateCompensation() * months; }
...
class Department {
    ...
    public Department(String deptCode, String deptName, String hod) {
        this.deptCode = deptCode; this.deptName = deptName; this.hod = hod;
    }
...
public class StaffPayrollSystem {
    public static void main(String[] args) {
        ...
        AcademicStaff as = new AcademicStaff("ST01", "Dr. Nusrat", "1985-04-12",
                "Associate Prof", 75000.0, 2015, 18, 15000.0, "ML");

        SeniorProfessor sp = new SeniorProfessor("ST02", "Prof. Jamal", "1970-09-01",
                "Professor", 120000.0, 2005, 45, 30000.0, "AI", 8, 20000.0);
