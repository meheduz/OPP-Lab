...
abstract class MenuItem {
    ...
    public double orderTotal(int quantity) { return unitPrice * quantity; }
...
class ChefSpecial extends FoodItem {
    ...
    public ChefSpecial(String itemCode, String itemName, double unitPrice, String cuisineType, int prepTimeMins,
                       String chefName, double signatureDiscount) {
    ...
    public double orderTotal(int quantity) {
        return getUnitPrice() * quantity * (1 - signatureDiscount / 100.0);
    }
...
public class RestaurantSystem {
    public static void main(String[] args) {
        ...
        ChefSpecial cs = new ChefSpecial("CS01", "Hilsa Curry", 400.0, "Bengali", 25, "Chef Rahim", 10.0);
        BeverageItem b = new BeverageItem("BV01", "Mango Lassi", 120.0, "Cold", 300);
