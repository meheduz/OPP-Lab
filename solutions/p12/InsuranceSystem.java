...
interface Claimable { void processClaim(); }
...
abstract class Entity {
    ...
    public Entity(String entityId, String fullName, String contactNumber) {
        this.entityId = entityId; this.fullName = fullName; this.contactNumber = contactNumber;
    }
    public Entity(String entityId, String fullName) { this(entityId, fullName, ""); }
...
abstract class PolicyHolder extends Entity implements Claimable {
    ...
    public PolicyHolder(String entityId, String fullName, String contactNumber, int age, String policyNumber) {
        ...
        this.age = age; this.policyNumber = policyNumber;
        totalPolicies++;
    }
...
class LifeInsured extends PolicyHolder {
    ...
    public LifeInsured(String entityId, String fullName, String contactNumber, int age, String policyNumber,
                       String nomineeName, String nomineeRelation) {
        super(entityId, fullName, contactNumber, age, policyNumber);
        this.nomineeName = nomineeName; this.nomineeRelation = nomineeRelation;
    }
...
class SeniorLifeInsured extends LifeInsured {
    ...
    public SeniorLifeInsured(String entityId, String fullName, String contactNumber, int age, String policyNumber,
                             String nomineeName, String nomineeRelation, double medicalAllowance) {
        super(entityId, fullName, contactNumber, age, policyNumber, nomineeName, nomineeRelation);
        this.medicalAllowance = medicalAllowance;
        this.hasSpecialBenefit = true;
    }
    ...
    public void processClaim() {
        ...
        if (hasSpecialBenefit) System.out.println("Special Benefit activated! Medical Allowance: " + medicalAllowance);
    }
...
class InsurancePolicy {
    ...
    public InsurancePolicy(String policyType, double coverageAmount, double basePremiumRate) {
        this.policyType = policyType; this.coverageAmount = coverageAmount; this.basePremiumRate = basePremiumRate;
    }
    public String getPolicyType() { return policyType; }
    public double getCoverageAmount() { return coverageAmount; }
    public double getBasePremiumRate() { return basePremiumRate; }
...
public class InsuranceSystem {
    public static void main(String[] args) {
        ...
        LifeInsured li = new LifeInsured("E001", "Nasrin", "01711000001",
                45, "POL001", "Rahim", "Spouse");

        SeniorLifeInsured si = new SeniorLifeInsured("E002", "Kamal", "01822000002",
